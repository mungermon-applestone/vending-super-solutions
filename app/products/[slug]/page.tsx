  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <Link 
          href="/products" 
          className="inline-flex items-center text-blue-600 hover:text-blue-800 py-4"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <a 
                  href="#request-demo" 
                  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded font-medium transition-colors text-sm"
                >
                  Request a Demo
                </a>
                <Link 
                  href="/products"
                  className="border border-gray-300 hover:bg-gray-100 text-gray-700 px-6 py-3 rounded font-medium transition-colors text-sm"
                >
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {product.features.map((feature) => (
                  <div key={feature.id} className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <section className="max-w-6xl mx-auto mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Recommended Machines</h2>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <a href="#" className="text-blue-600 hover:text-blue-800 flex items-center font-medium text-sm">
                    View details
        ...
        {/* Contact Section */}
        <section id="request-demo" className="max-w-6xl mx-auto bg-gray-50 rounded-lg p-8 mb-16">
