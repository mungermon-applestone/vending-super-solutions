...
const Locker10Cell = () => {
  ...
  const fallbackMachineData = {
    ...
    images: [
      { id: 'locker10-img-1', url: "https://images.unsplash.com/photo-1604754742629-3e5728249d73", alt: "10-cell Temperature Controlled Locker - Front View" },
      { id: 'locker10-img-2', url: "https://images.unsplash.com/photo-1617474019494-585d69168617", alt: "10-cell Temperature Controlled Locker - In Use" }
    ],
    specs: {
    ...
    deploymentExamples: [
      {
        ...
        image: { id: 'locker10-deploy-1', url: "https://images.unsplash.com/photo-1471864190281-a93a3070b6de", alt: "Pharmacy deployment" }
      },
      {
        title: "Restaurant",
        description: "Food delivery and pickup solution maintaining proper food temperatures",
        image: { id: 'locker10-deploy-2', url: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4", alt: "Restaurant deployment" }
      },
      {
        title: "Grocery Store",
        description: "Order pickup solution for temperature-sensitive items",
        image: { id: 'locker10-deploy-3', url: "https://images.unsplash.com/photo-1542838132-92c53300491e", alt: "Grocery store deployment" }
      }
    ]
  };
