...
import { Server, Ruler, Weight, Plug, ThermometerSnowflake, DollarSign } from 'lucide-react';
              ...
              <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-vending-gray p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    Fresh food, beverages, sandwiches, salads, yogurt, and other perishable items requiring refrigeration.
                  </p>
                </div>
                <div className="bg-vending-gray p-6 rounded-lg">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold mb-2 text-vending-blue-dark">
                Interested in {machineData.title}?
              </h2>
