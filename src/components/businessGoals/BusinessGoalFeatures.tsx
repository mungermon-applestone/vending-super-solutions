...
const BusinessGoalFeatures = ({ features }: BusinessGoalFeaturesProps) => {
  return (
    <section className="py-16 bg-white">
      <div className="container-wide">
        ...
        <p className="text-center text-xl text-gray-700 mb-12 max-w-3xl mx-auto">
          Our platform provides specialized features to help you achieve this business goal effectively.
        </p>
