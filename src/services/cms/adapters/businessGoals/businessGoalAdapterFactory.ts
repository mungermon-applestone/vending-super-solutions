...
import { ContentProviderType, ProviderConfig } from '../types';
 ...
 */
export const getBusinessGoalAdapter = (config?: ProviderConfig): BusinessGoalAdapter => {
  try {
 ...
 */
export async function validateBusinessGoalAdapter(config: ProviderConfig): Promise<boolean> {
  try {
